...
export class PhotoMap {
  ...
  _showMini(gps, name) {
    ...
    // Container may have been display:none (previous photo without GPS):
  ...
  _openModal() {
    ...
    // Leaflet cached a zero size. Wait two frames for the browser to finish layout
    // then recalibrate before positioning the view.
