export default {
  ...
  'home.globeCard.name':  'Globe 3D',
  'home.globeCard.sub':   'Vue 3D de la Terre',
  'word.album':           'album{s}',
  'word.photo':           'photo{s}',
  ...
  'viewer.downloadZip':  'Télécharger l\'album (ZIP)',
  'viewer.share':        'Partager',
  'viewer.shareTitle':   'Partager l\'album',
  'viewer.shareDuration':'Durée',
  'viewer.share1d':      '1 jour',
  'viewer.share7d':      '7 jours',
  'viewer.share30d':     '30 jours',
  'viewer.shareCreate':  'Créer un lien',
  'viewer.shareCopy':    'Copier',
  'viewer.shareCopied':  'Copié !',
  'viewer.shareExpires': 'Expire le {date}',
  'viewer.shareError':   'Impossible de créer le lien de partage.',
  'viewer.exif':         'Informations EXIF',

  // EXIF fields
  'exif.camera':       'Appareil',
  'exif.lens':         'Objectif',
  'exif.dateTime':     'Date / Heure',
  'exif.iso':          'ISO',
  'exif.aperture':     'Ouverture',
  'exif.shutterSpeed': 'Vitesse',
