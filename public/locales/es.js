export default {
  ...
  'viewer.downloadZip':  'Descargar álbum (ZIP)',
  'viewer.share':        'Compartir',
  'viewer.shareTitle':   'Compartir álbum',
  'viewer.shareDuration':'Duración',
  'viewer.share1d':      '1 día',
  'viewer.share7d':      '7 días',
  'viewer.share30d':     '30 días',
  'viewer.shareCreate':  'Crear enlace',
  'viewer.shareCopy':    'Copiar',
  'viewer.shareCopied':  '¡Copiado!',
  'viewer.shareExpires': 'Expira el {date}',
  'viewer.shareError':   'No se pudo crear el enlace.',
  'viewer.exif':         'Info EXIF',

  // EXIF fields
  'exif.camera':       'Cámara',
  'exif.lens':         'Objetivo',
  'exif.dateTime':     'Fecha / Hora',
  'exif.iso':          'ISO',
  'exif.aperture':     'Apertura',
  'exif.shutterSpeed': 'Velocidad',
  'exif.focalLength':  'Focal',
  'exif.dimensions':   'Dimensiones',
  ...
  // Push notifications
  'viewer.subscribe':      'Suscribirse a las notificaciones',
  'viewer.unsubscribe':    'Cancelar suscripción',
  'viewer.subscribed':     'Suscrito',
  'admin.pushSubscribers': 'Suscriptores push',
  'admin.notifyTitle':     'Título',
  'admin.notifyBody':      'Mensaje',
  'admin.notifySend':      'Enviar',
  'admin.notifySent':      '¡Enviado!',
};
